...
print("\n===== Health Insurance Fraud Model Training =====\n")
...
pickle.dump(best_model, open("model/health_model.pkl", "wb"))
pickle.dump(scaler, open("model/health_scaler.pkl", "wb"))

print("\n✅ Health fraud model saved successfully!")